 ...
 */
final class Version20210712134714 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE t_pizza CHANGE DesignPizz DesignPizz VARCHAR(255) NOT NULL, CHANGE TarifPizz TarifPizz NUMERIC(5, 2) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE t_pizza CHANGE DesignPizz DesignPizz VARCHAR(255) CHARACTER SET latin1 DEFAULT NULL COLLATE `latin1_swedish_ci`, CHANGE TarifPizz TarifPizz NUMERIC(5, 2) DEFAULT NULL');
    }
}
